                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <input name="marca" id="marca" value="{{ $product->marca }}" class="py-2 px-3 rounded-lg border-2 border-blue-500 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                        </div>
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-black-500 text-light font-semibold">LÍNEA:</label>
                            <input name="linea" id="linea" value="{{ $product->linea }}" class="py-2 px-3 rounded-lg border-2 border-blue-500 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                        </div>
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-black-500 text-light font-semibold">ESPECIFICACIONES:</label>
                            <input name="especificaciones" id="especificaciones" value="{{ $product->especificaciones }}" class="py-2 px-3 rounded-lg border-2 border-blue-500 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                        </div>
                        <div class="grid grid-cols-1">
